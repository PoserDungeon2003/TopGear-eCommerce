...
<!--        <div class="container text-center">
        ...
        <p style="font-size: 50px; color: white; text-align: center" class="">
            Welcome Session Tracking
        </p>
        <h3 style="font-size: 50px; color: white" class="">
